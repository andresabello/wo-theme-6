	...
	public function widget( $args, $instance ) {
		...
		<div class="ac-form">
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
				...
				<input type="text" name="ac_choice" placeholder="Drug of choice">
				<input type="text" name="ac_time" placeholder="How long using it">
...
function acform_render( $atts, $description = '' ) {
	...
	$atts = shortcode_atts( array(
		...
		$content = '<div class="ac-form contact-page-form">';
		...
		$content .= '<button class="ac-submit" name="ac-submit" type="submit">Take the First Step</button>';
		$content .= '</form></div>';
		return $content;
}
